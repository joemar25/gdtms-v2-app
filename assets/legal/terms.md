...
The App is provided exclusively to authorized couriers of Fastrak Services Inc. ("FSI") for the purpose of managing delivery operations. You must not:

- Share your account credentials with any other person.
- Use the App for any purpose other than authorized delivery operations.
- Attempt to reverse-engineer, decompile, or modify the App.
- Use the App in a manner that violates applicable laws or regulations.

---

## 3. Account Responsibilities

You are responsible for maintaining the confidentiality of your login credentials. Any activity that occurs under your account is your responsibility. You must notify FSI immediately if you suspect unauthorized access to your account.
...
The App is designed to operate offline. Data collected while offline will be automatically synchronized to FSI servers when an internet connection is restored. You are responsible for ensuring that your device has sufficient storage to capture delivery records while offline.

---

## 7. Media Uploads

Photos, signatures, and other media captured through the App are the property of FSI and are used solely for proof-of-delivery and operational purposes. Media may be stored on secure cloud servers (AWS S3 or equivalent).

---

## 8. Termination

FSI reserves the right to suspend or terminate your access to the App at any time if you violate these Terms or if your employment or engagement with FSI is terminated.

---

## 9. Disclaimers

The App is provided "as is" without warranties of any kind. FSI does not guarantee that the App will be error-free or uninterrupted. FSI is not liable for any damages arising from your use of or inability to use the App.

---

## 10. Changes to Terms

FSI may update these Terms from time to time. You will be notified within the App when Terms are updated. Continued use of the App after changes constitutes acceptance of the updated Terms.
